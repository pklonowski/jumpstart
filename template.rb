...
def ask_optional_options
  @erd = yes?('Do you want to generate entity-relationship diagrams (GraphViz required) (y/n)?')
end
...
def add_bootstrap
  ...
  # Add Bootstrap JS
  #  While bootstrap-sprockets provides individual Bootstrap components for ease of debugging, you may
